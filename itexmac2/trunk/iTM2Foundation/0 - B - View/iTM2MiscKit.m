...
+ (void)prepareMiscKitCompleteInstallation;
{
	if([NSToolbar iTM2_swizzleInstanceMethodSelector:@selector(SWZ_iTM2Misc_setSizeMode:)])
	{
		iTM2_MILESTONE((@"NSToolbar(iTM2MiscKit)"),(@"setSizeMode: is not patched"));
	}
	if([NSPrintInfo iTM2_swizzleInstanceMethodSelector:@selector(SWZ_iTM2Misc_setPaperName:)]
	...
	{
		iTM2_MILESTONE((@"NSPrintInfo(iTM2MiscKit)"),(@"The print info is not patched, no advances available"));
	}
	if([NSTextView iTM2_swizzleInstanceMethodSelector:@selector(SWZ_iTM2Misc_resetCursorRects)])
	{
		iTM2_MILESTONE((@"NSTextView(iTM2MiscKit)"),(@"No resetCursorRects patch available"));
	}
	if([NSPageLayout iTM2_swizzleInstanceMethodSelector:@selector(SWZ_iTM2Misc_writePrintInfo)])
	{
		iTM2_MILESTONE((@"NSPageLayout(iTM2MiscKit)"),(@"No writePrintInfo patch available."));
	}
}
@end
