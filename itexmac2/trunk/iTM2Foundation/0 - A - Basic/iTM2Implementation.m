...
//iTM2_START;
	...
	[I iTM2_invokeWithSelectors:[iTM2Runtime instanceSelectorsOfClass:isa withSuffix:@"FixImplementation" signature:[I methodSignature] inherited:YES]];
   return;
}
...
+ (void)prepareImplementationCompleteInstallation;
{
	if([NSObject iTM2_swizzleInstanceMethodSelector:@selector(SWZ_iTM2Impl_valueForUndefinedKey:)]
		&& [NSObject iTM2_swizzleInstanceMethodSelector:@selector(SWZ_iTM2Impl_setValue:forUndefinedKey:)])
	{
		iTM2_MILESTONE((@"NSObject(iTM2Implementation)"),(@"setValue:forUndefinedKey: does not take into account the implementation design"));
	}
}
