...
//iTM2_START;
	if(aNode != _Parent)
	{
		...
		_Parent = aNode;
		if([_Parent indexOfObjectInChildren:self] == (NSUInteger)NSNotFound)
		{
...
- (NSUInteger)indexOfObjectInChildren:(id)anObject;
/*"Description Forthcoming.
Version history: jlaurens AT users DOT sourceforge DOT net
- for 2.0: Sat May 24 2003
To Do List:
...
//iTM2_START;
	...
	NSUInteger index = [_Children indexOfObject:anObject];
...
- (void)insertObject:(iTM2TreeNode *)node inChildrenAtIndex:(NSUInteger)index;
/*"Description forthcoming.
Version history: jlaurens AT users DOT sourceforge DOT net
- for 2.0: Sat May 24 2003
To Do List:
...
- (void)replaceObjectInChildrenAtIndex:(NSUInteger) index withObject:(iTM2TreeNode *)node;
/*"Description forthcoming.
Version history: jlaurens AT users DOT sourceforge DOT net
- for 2.0: Sat May 24 2003
To Do List:
...
- (id)initWithXMLElement:(NSXMLElement *)element;
{
	if(self = [self init])
	{
		...
		{
			self->isa = [iTM2PatriciaLeafNode class];
		}
...
nextCharacter:
				...
				else
				{
					...
					{
						self->isa = [iTM2PatriciaNode class];
						return YES;
					}
					else
					{
...
- (iTM2LinkedNode *)firstSibling;
{
	iTM2LinkedNode * sibling = self;
	iTM2LinkedNode * previousSibling = sibling;
...
- (iTM2LinkedNode *)lastSibling;
{
	iTM2LinkedNode * sibling = self;
	iTM2LinkedNode * nextSibling = sibling;
	while(nextSibling)
	{
		sibling = nextSibling;
...
- (iTM2LinkedNode *)root;
{
	iTM2LinkedNode * parent = self;
	iTM2LinkedNode * first = parent;
	while(first)
	{
		parent = first;
...
- (iTM2LinkedNode *)deepestFirstChild;
{
	iTM2LinkedNode * child = self;
	iTM2LinkedNode * first = child;
	while(first)
	{
		child = first;
...
- (iTM2LinkedNode *)deepestLastChild;
{
	iTM2LinkedNode * child = self;
	iTM2LinkedNode * last = child;
	while(last)
	{
		child = last;
...
- (iTM2LinkedNode *)nextNode;
{
	iTM2LinkedNode * result;
	...
	iTM2LinkedNode * parent = self.parent;
	if(parent)
	{
tijuana:
...
- (iTM2LinkedNode *)previousNode;
{
	iTM2LinkedNode * result = self.previousSibling;
...
- (void)insertSibling:(iTM2LinkedNode *)theNode;
{
	if(!theNode)
	{
		return;
	...
	[theNode detach];
	iTM2LinkedNode * sibling = [theNode lastSibling];
	sibling.nextSibling = self.nextSibling;
	iTM2LinkedNode * node = theNode;
	self.nextSibling.previousSibling = node;
...
- (void)removeChildren;
{
	iTM2LinkedNode * node = self.firstChild;
	while(node)
	{
		node.parent = nil;
...
- (void)removeSiblings;
{
	iTM2LinkedNode * node = self.nextSibling;
	if(node)
	{
...
- (void)updateCountOfObjectsInChildNodes;
{
	...
	if(_FirstChild)
	{
		...
		iTM2LinkedNode * child = self.firstChild;
...
- (NSString *)description;
{
	...
	else if(self.previousSibling && (self != self.previousSibling.nextSibling))
	{
		status = @"(BAD Owner)";
	}
...
@synthesize countOfObjectsInChildNodes=_CountOfObjectsInChildNodes;
@synthesize value=_Value;
@end
