...
/*!
	...
	nil is returned when nothing has been added, either there was nothing to add or there was an error or the child item was already listed in the child items array.
*/
- (void)insertObject:(iTM2TreeNode *)anObject inChildrenAtIndex:(NSUInteger)index;
...
/*!
	...
	@result		None.
*/
- (void)replaceObjectInChildrenAtIndex:(NSUInteger) index withObject:(iTM2TreeNode *) anObject;
...
/*!
	...
	@result		None.
*/
- (NSUInteger)indexOfObjectInChildren:(iTM2TreeNode *)anObject;
...
@private
	id __weak _Parent;
	id _FirstChild;
	id __weak _LastChild;
	id  _NextSibling;
	id __weak _PreviousSibling;
	NSUInteger _CountOfObjectsInChildNodes;
	NSString * _Value;
}
...
/*!
	...
	@result		None.
*/
- (void)insertSibling:(iTM2LinkedNode *)node;
...
/*!
	...
	@result		None.
*/
- (void)insertFirstChild:(iTM2LinkedNode *)node;
...
- (iTM2LinkedNode *)initWithValue:(id)value;

@property (assign) iTM2LinkedNode * __weak parent;
@property (retain) iTM2LinkedNode * firstChild;
@property (assign) iTM2LinkedNode * __weak lastChild;
@property (retain) iTM2LinkedNode * nextSibling;
@property (assign) iTM2LinkedNode * __weak previousSibling;
