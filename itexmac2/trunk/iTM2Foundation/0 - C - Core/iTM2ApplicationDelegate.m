...
//iTM2_START;
	...
	NSPointerArray * PA = [iTM2Runtime realInstanceSelectorsOfClass:isa withSuffix:@"ApplicationShouldTerminate:" signature:[I methodSignature] inherited:YES];
...
//iTM2_START;
    ...
    [I iTM2_invokeWithSelectors:[iTM2Runtime realInstanceSelectorsOfClass:isa withSuffix:@"ApplicationWillTerminate:" signature:[I methodSignature] inherited:YES]];
//iTM2_END;
    return;
}
