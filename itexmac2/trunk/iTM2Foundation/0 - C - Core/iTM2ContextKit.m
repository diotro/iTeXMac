...
//iTM2_START;
    ...
    for(id selector in [iTM2Runtime instanceSelectorsOfClass:[self class] withSuffix:@"CompleteSaveContext:" signature:[I methodSignature] inherited:YES])
    {
...
//iTM2_START;
    ...
    for(id selector in [iTM2Runtime instanceSelectorsOfClass:[self class] withSuffix:@"CompleteLoadContext:" signature:[I methodSignature] inherited:YES])
    {
        [I setSelector:(SEL)selector];
        [I invoke];
    }
