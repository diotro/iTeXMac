...
enum
{
	...
	kiTM2TeXPlaceholderSyntaxMask = kiTM2TextPlaceholderSyntaxMask,
	kiTM2TeXSimpleGroupSyntaxMask = kiTM2TeXPlaceholderSyntaxMask << 1,
...
//	Placeholders
    kiTM2TeXPlaceholderDelimiterMode,// "__(" or ")__"
//  Everything else
...
/*!
    @method	loadSymbolsAttributesAtURL:
    @abstract	Load the symbols attributes at the given url.
    @discussion	Reads all the files named url/file.symbols
...
/*!
    @method	symbolsAttributesWithContentsOfURL:
...
/*!
    @method	writeSymbolsAttributes:toURL:
...
/*!
	@method			TeXLetterCharacterSet4iTM3
...
/*!
	@method			TeXFileNameLetterCharacterSet4iTM3
