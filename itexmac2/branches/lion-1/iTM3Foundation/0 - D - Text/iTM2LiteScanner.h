...
@private
    ...
    NSUInteger scanLimit;
    BOOL caseSensitive;
//    iTM2CharacterAtIndexIMP CAI;
}
@property (readwrite,retain) NSString * string;
@property (readwrite,retain) NSCharacterSet * charactersToBeSkipped;
@property (readwrite,assign) NSUInteger scanLocation;
@property (readwrite,assign) NSUInteger scanLimit;
@property (readwrite,assign,getter=isCaseSensitive) BOOL caseSensitive;
/*"Class methods"*/
...
- (BOOL)scanEOLIntoString:(NSString **)value;
@end

/*  For subclassers */
@interface iTM2LiteScanner (String) 
- (BOOL)scanCommentCharacter;// default implementation: try to scan one '%' character
- (BOOL)scanCommentSequence;// default implementation: try to scan one '%!' or '%:' character
@end
