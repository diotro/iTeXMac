/*
//
//  @version Subversion: $Id: iTM2KeyBindingsKit.h 794 2009-10-04 12:33:28Z jlaurens $ 
//
...
- (NSString *)key;
- (NSString *)altKey;
@property (getter=modifierFlags,setter=setModifierFlags:) NSUInteger modifierFlags;
@end
...
/*!
    ...
    @discussion	A key binding manager stores a hierarchy of dictionaries which keys are keystroke and values are macro identifiers.
                A combination of keyStrokes4iTM3 corresponds to a string or a macro to be inserted in some text.
...
@private
    ...
    {
        NSUInteger handlesKeyBindings: 1;
        NSUInteger handlesKeyStrokes: 1;
        NSUInteger isDeepEscaped: 1;
        NSUInteger isEscaped: 1;
        NSUInteger isPermanent: 1;
        NSUInteger canEscape: 1;
...
/*!
    ...
    @discussion	Here are the rules for the identifier.
                ...
                where DOMAIN loops into ~, /, /Network, iTM3Foundation bundle built in resources
...
/*!
    ...
    @discussion	Some keyStrokes4iTM3 can imply loading another key bindings tree or go deeper in the tre  hierarchy.
...
/*
    ...
    @abstract	See the PDF window implementation to see an example of key stroke use.
                ...
                Basically, the key binding will define a key->interpretKeyStroke4iTM3: event
    @discussion	Discussion forthcoming
*/
@interface NSResponder(iTM2KeyStrokeKit)

/*
    @method		keyStrokeEvents4iTM3
    @abstract	Abstract forthcoming
    @discussion	Discussion forthcoming
    @param		None
    @result		None
...
/*
    @method		pushKeyStrokeEvent4iTM3:
...
/*
    @method		flushKeyStrokeEvents4iTM3:
...
/*
    @method		flushLastKeyStrokeEvent4iTM3:
...
/*
    @method		interpretKeyStroke4iTM3:
...
/*
    @method		tryToReallyPerform4iTM3:with:
...
/*
    ...
    @abstract	The interpretKeyStroke4iTM3: is overriden
    @discussion	Discussion forthcoming
*/
@interface NSObject(iTM2KeyStrokeKit)

/*
    @method     handlesKeyStrokes4iTM3
...
/*
    @method		handlesKeyBindings4iTM3
...
/*!
    @method		keyBindingsManager4iTM3
