...
//START4iTM3;
    ...
    if (!cursor)
    {
        NSString * path = [[NSBundle iTM3FoundationBundle] pathForImageResource:@"iTM2ZoomInCursor"];
        if (path)
		{
...
//START4iTM3;
    ...
    if (!cursor)
    {
        NSString * path = [[NSBundle iTM3FoundationBundle] pathForImageResource:@"iTM2ZoomOutCursor"];
        if (path)
		{
			NSImage * I = [[[NSImage alloc] initWithContentsOfFile:path] autorelease];
...
//START4iTM3;
    ...
    if (!cursor)
    {
        NSString * path = [[NSBundle iTM3FoundationBundle] pathForImageResource:@"iTM2CancelCursor"];
        if (path)
		{
			NSImage * I = [[[NSImage alloc] initWithContentsOfFile:path] autorelease];
...
//START4iTM3;
    ...
    if (!cursor)
    {
        NSString * path = [[NSBundle iTM3FoundationBundle] pathForImageResource:@"iTM2CrossHair"];
        if (path)
		{
			NSImage * I = [[[NSImage alloc] initWithContentsOfFile:path] autorelease];
...
//START4iTM3;
	...
	if (!cursor)
	{
		NSString * path = [[NSBundle iTM3FoundationBundle] pathForImageResource:@"iTM2WhiteIBeam"];
        if (path)
		{
			NSImage * I = [[[NSImage alloc] initWithContentsOfFile:path] autorelease];
