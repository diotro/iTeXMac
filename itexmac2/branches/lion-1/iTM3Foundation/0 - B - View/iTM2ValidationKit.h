/*
//
//  @version Subversion: $Id: iTM2ValidationKit.h 715 2008-02-06 12:45:30Z jlaurens $ 
//
...
+ (iTM2ValidationStatus)target4iTM3:(id)target validateUserInterfaceItem:(id)sender;
