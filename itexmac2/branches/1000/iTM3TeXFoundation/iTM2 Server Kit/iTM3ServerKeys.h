...
extern NSString * const iTM3ServerEnvironmentKey;
extern NSString * const iTM3ServerArgumentsKey;
extern NSString * const iTM3ServerConnectionIDKey;
extern NSString * const iTM3ServerPerformProjectActionWithContextNotification;

/*
	@class		iTM3ServerKeys
