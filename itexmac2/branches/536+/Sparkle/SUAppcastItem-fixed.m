...
//JL-ADDENDUM<
#else
	NSString * JL_urlString = [enclosure objectForKey:@"url"];
	NSString * JL_string = [JL_urlString stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
	if(JL_string)
	{
		[self setFileURL:[NSURL URLWithString:JL_string]];
	}
#endif
//>JL-ADDENDUM
