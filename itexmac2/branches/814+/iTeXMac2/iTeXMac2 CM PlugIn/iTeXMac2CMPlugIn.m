...
#define INIT_POOL4iTM3 NSAutoreleasePool * __P_O_O_L__ = [[NSAutoreleasePool alloc] init]
#define RELEASE_POOL4iTM3 [__P_O_O_L__ release]
												...
												AEDescList*	ioCommandListRef)
{
	...
	NSUInteger length = commandName.length;
