...
/*!
    @method     newDocumentFromRunningAssistantPanelForProject4iTM3:
...
@interface iTM2NewDocumentAssistant: iTM2Inspector <NSOutlineViewDataSource, NSOutlineViewDelegate, NSOpenSavePanelDelegate, NSWindowDelegate>
{
@private
