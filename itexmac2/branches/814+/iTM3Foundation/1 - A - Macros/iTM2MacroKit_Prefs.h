...
@property (retain) id keysTreeController;
@property (retain) id macrosArrayController;
@property (retain) id macroTestView;
@property (assign) NSString * selectedMode;
@property (assign) NSString * selectedDomain;
@property (assign) id macroEditor;
