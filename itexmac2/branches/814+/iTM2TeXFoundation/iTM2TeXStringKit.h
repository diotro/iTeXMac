...
/*!
    @method     getWordBefore4iTM3:here:after:atIndex:mode:
...
*/
- (NSUInteger)getWordBefore4iTM3:(NSString **)beforePtr here:(NSString **)herePtr after:(NSString **)afterPtr atIndex:(NSUInteger)index mode:(BOOL)isSyncTeX;
