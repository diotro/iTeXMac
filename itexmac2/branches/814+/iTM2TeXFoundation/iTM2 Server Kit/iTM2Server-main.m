...
//NSLog(@"Launching iTeXMac2");
	NSString * temporaryDirectory4iTM3 = [[[NSProcessInfo processInfo] environment] objectForKey:@"TemporaryDirectory4iTM3"];
//NSLog(@"temporaryDirectory4iTM3 is: %@", temporaryDirectory4iTM3);
	if(temporaryDirectory4iTM3.length)
	{
        ...
        if([[NSWorkspace sharedWorkspace] launchApplication:
				[[temporaryDirectory4iTM3 stringByAppendingPathComponent:@"iTeXMac2.app"] stringByStandardizingPath]])
		{
