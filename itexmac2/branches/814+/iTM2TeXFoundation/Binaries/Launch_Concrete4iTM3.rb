...
class String
	...
	def properties
		if self =~ /(?:\((.*?)\))?([^\+-]*)(?:\+([^-]*))?(?:-(.*))?/
			return {'E'=>$1?$1:'','M'=>$2?$2:'','V'=>$4?$4:'','O'=>$3?$3:''}
		end
		{}
	end
	...
	def compare_properties(rhs)
		...
		if(lPs['M'] == "Default")
			if(rPs['M'] == "Default")
				if(lPs['E'] == rPs['E'] || lPs['E'] == "*" || rPs['E'] == "*")
					if(lPs['V'] == rPs['V'] || lPs['V'] == "*" || rPs['V'] == "*")
						if(lPs['O'] == "*" || rPs['O'] == "*")
							return 0
						end
						return lPs['O'] <=> rPs['O']
			...
			return +1
		elsif(lPs['M'] == "Plain" || lPs['M'] == "TeX")
			if(rPs['M'] == "Plain" || rPs['M'] == "TeX")
				if(lPs['E'] == rPs['E'] || lPs['E'] == "*" || rPs['E'] == "*")
					if(lPs['V'] == rPs['V'] || lPs['V'] == "*" || rPs['V'] == "*")
						if(lPs['O'] == "*" || rPs['O'] == "*")
							return 0
			...
			return -1
		elsif(rPs['M'] == "Plain" || rPs['M'] == "TeX")
			return +1
		elsif(lPs['M'] == rPs['M'] || lPs['M'] == "*" || rPs['M'] == "*")
			if(lPs['E'] == rPs['E'] || lPs['E'] == "*" || rPs['E'] == "*")
				if(lPs['V'] == rPs['V'] || lPs['V'] == "*" || rPs['V'] == "*")
					if(lPs['O'] == "*" || rPs['O'] == "*")
						return 0
