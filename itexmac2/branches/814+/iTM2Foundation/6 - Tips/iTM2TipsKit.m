...
#warning ERROR availablePlugInPathsAtPath has changed
	...
	[paths addObjectsFromArray: [[mainBundle class] availablePlugInPathsAtPath:
		[[mainBundle class] pathForSupportDirectory4iTM3: iTM2SupportPluginsComponent inDomain: NSUserDomainMask
			withName: [mainBundle bundleName4iTM3] create: YES]
				ofType: @"prefPane"]];
	[paths addObjectsFromArray: [[mainBundle class] availablePlugInPathsAtPath:
		[[mainBundle class] pathForSupportDirectory4iTM3: iTM2SupportPluginsComponent inDomain: NSLocalDomainMask
			withName: [mainBundle bundleName4iTM3] create: YES]
				ofType: @"prefPane"]];
	[paths addObjectsFromArray: [[mainBundle class] availablePlugInPathsAtPath:
		[[mainBundle class] pathForSupportDirectory4iTM3: iTM2SupportPluginsComponent inDomain: NSNetworkDomainMask
			withName: [mainBundle bundleName4iTM3] create: YES]
				ofType: @"prefPane"]];
	[paths addObjectsFromArray: [[mainBundle class] availablePlugInPathsAtPath: [mainBundle builtInPlugInsPath] ofType: @"prefPane"]];
	NSInteger newCount = paths.count;
	NSInteger oldCount;
	do {
		oldCount = newCount;
...
//START4iTM3;
	...
	if(already)
		return;
	already = YES;
	if(![NSPreferencePane swizzleInstanceMethodSelector4iTM3: @selector(SWZ_iTM2PreferenceKit_loadMainView)])
	{
...
//END4iTM3;
		...
		LOG4iTM3(@"..........  ERROR: Missing a nib for this preference pane...");
//END4iTM3;
		return nil;
	}
}
