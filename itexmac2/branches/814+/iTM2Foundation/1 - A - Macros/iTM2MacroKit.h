/*
//
//  @version Subversion: $Id: iTM2MacroKit.h 794 2009-10-04 12:33:28Z jlaurens $ 
//
...
/*!
    @method		executeMacroWithID4iTM3:
...
/*!
    @method		executeMacroWithID4iTM3:
    @abstract	Execute the given macro.
    @discussion	Overriden to take into account the responder chain -tryToPerform:withObject: through -tryToExecuteMacroWithID4iTM3:.
    @param		A macro.
    @result		A flag indicating whether the receiver has executed the given macro.
*/
- (BOOL)executeMacroWithID4iTM3:(NSString *)macro;
- (BOOL)tryToExecuteMacroWithID4iTM3:(NSString *)macro;//fake
...
@interface iTM2StringController(MacroKit)

/*!
	@method		rangeOfPlaceholderAtIndex:getType:ignoreComment:inString:
	@abstract	Abstract forthcoming.
...
/*!
	@method		stringByRemovingPlaceholderMarksInString:
	@abstract	Abstract forthcoming.
