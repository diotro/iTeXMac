/*
//
//  @version Subversion: $Id: iTM2DocumentKit.h 795 2009-10-11 15:29:16Z jlaurens $ 
//
...
/*!
    ...
    @discussion	Manages the IO, the interface type, the up to date state. Semi abstract class (does nothing?)
                ...
                - the class objects are uniquely identified by an inspectorType4iTM3 and an inspectorMode.
                ...
                - each inspector is uniquely identified by an inspectorType4iTM3 and a inspectorMode, it also has a documentTypes array used
                    by the document to find a default inspector for that document using its fileType.
                - each document class has an inspectorType4iTM3, all the inspectors with that type are expected to fit that document.
...
/*!
    @method		prettyInspectorType4iTM3
...
/*!
    @method		smartClose4iTM3
    @abstract	Close if it can close...
    @discussion	If the document is authorized to close, it will send a documentWillClose4iTM3,
				then close then send a documentDidClose4iTM3 message.
    @param		None.
    @result		None.
*/
...
{
@private
    id implementation4iTM3;
}
@property (readonly,assign) id implementation;
/*!
...
/*!
    @method		directoryURL
    @abstract	The directory URL of the receiver.
...
/*! 
    ...
    @discussion The inherited method is overriden.
				...
				The dataCompleteReadFromURL4iTM3:ofType:error: is the only one method available.
...
/*! 
    ...
    @result     A flag.
*/
- (BOOL)dataCompleteReadFromURL4iTM3:(NSURL *)absoluteURL ofType:(NSString *)typeName error:(NSError**)outputError;

/*! 
    @method     resourcesCompleteReadFromURL4iTM3:ofType:error:
    @abstract   read the resources from the given url
    @discussion Preserves the resources.
                If the receiver implements a method like
                - (void) loadXXXIDResource4iTM3: (id) resourceContent;
...
/*! 
    ...
    @result     A flag.
*/
- (BOOL)dataCompleteWriteToURL4iTM3:(NSURL *)absoluteURL ofType:(NSString *)typeName error:(NSError**)outputError;

/*! 
    @method     resourcesCompleteWriteToURL4iTM3:ofType:error:
    @abstract   write the resources to the given file
    @discussion Preserves the resources.
                If the receiver implements a method like
                - (void) getXXXIDResource4iTM3: (id *) resourceContentPtr;
    ...
    @result     A flag.
*/
- (BOOL)resourcesCompleteWriteToURL4iTM3:(NSURL *)absoluteURL ofType:(NSString *)typeName error:(NSError**)outputError;
...
/*!
    ...
    @discussion	With the standard behaviour, all the message blahWindowWillLoad4iTM3 are sent.
...
/*!
    ...
    @abstract	Overriden behaviour.
    @discussion	With the standard behaviour, all the message blahWindowDidLoad4iTM3 are sent.
				The inherited ones are not sent by the receiver because they are expected to be sent by the ancestor.
				Inherited messages are sent before the receiver's ones.
    @param		None.
    @result		None.
...
/*!
    ...
    @discussion	This message is sent in the windowDidLoad method.
				...
				Any relevant selector matching *CompleteBackupModel4iTM3 is sent to the receiver.
