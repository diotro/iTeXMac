...
- (void) testCase_URLsForSupportResource4iTM3_A;
{
    ...
    NSError * ROR = nil;
    [DFM removeItemAtURL:URL_B error:self.RORef4iTM3];
    ...
    [DFM createDirectoryAtPath:URL_R.path withIntermediateDirectories:YES attributes:[NSDictionary dictionary] error:self.RORef4iTM3];
    BOOL yorn = NO;
...
#   define EXT  @"EXT"
    ...
    ROR = nil;
    STAssertTrue(([D writeToURL:URL_D options:ZER0 error:self.RORef4iTM3]),@"MISSED",NULL);
    STAssertNil(ROR,@"MISSED",NULL);
#   define SUBDIR @"COUCOU"
    NSURL * URL_S = [URL_R URLByAppendingPathComponent:SUBDIR];
    [DFM createDirectoryAtPath:URL_S.path withIntermediateDirectories:YES attributes:[NSDictionary dictionary] error:self.RORef4iTM3];
    NSURL * URL_SD = [URL_S URLByAppendingPathComponent:NAME@"."EXT];
    ROR = nil;
    STAssertTrue(([D writeToURL:URL_SD options:ZER0 error:self.RORef4iTM3]),@"MISSED",NULL);
    STAssertNil(ROR,@"MISSED",NULL);
...
- (void) testCase_URLXtdAttributes
{
    ...
    NSError * ROR = nil;
    NSArray * RA = [URL getXtdAttributeNames4iTM3WithOptions:ZER0 error:self.RORef4iTM3];
    ...
    STAssertFalse(([URL setXtdAttribute4iTM3:aValue forName:aName options:ZER0 error:self.RORef4iTM3]),@"MISSED",NULL);
    ...
    RA = [URL getXtdAttributeNames4iTM3WithOptions:ZER0 error:self.RORef4iTM3];
    STAssertNotNil(RA,@"MISSED",NULL);
    STAssertTrue((RA.count==ZER0),@"MISSED",NULL);
    STAssertNotNil(ROR,@"MISSED",NULL);
    ROR = nil;
    STAssertTrue(([URL setXtdAttribute4iTM3:aValue forName:aName options:ZER0 error:self.RORef4iTM3]),@"MISSED",NULL);
    STAssertNil(ROR,@"MISSED",NULL);
    RA = [URL getXtdAttributeNames4iTM3WithOptions:ZER0 error:self.RORef4iTM3];
    STAssertNotNil(RA,@"MISSED",NULL);
    ...
    STAssertNil(ROR,@"MISSED",NULL);
    STAssertEqualObjects(aValue,([URL getXtdAttribute4iTM3ForName:aName options:ZER0 error:self.RORef4iTM3]),@"MISSED",NULL);
    STAssertNil(ROR,@"MISSED",NULL);
    ...
    STAssertEqualObjects(aValue,([URL getXtdAttribute4iTM3ForName:aName options:ZER0 error:self.RORef4iTM3]),@"MISSED",NULL);
    STAssertNil(ROR,@"MISSED",NULL);
    STAssertFalse(([URL removeXtdAttribute4iTM3ForName:@"" options:ZER0 error:self.RORef4iTM3]),@"MISSED",NULL);
    STAssertNotNil(ROR,@"MISSED",NULL);
    ROR = nil;
    STAssertTrue(([URL removeXtdAttribute4iTM3ForName:aName options:ZER0 error:self.RORef4iTM3]),@"MISSED",NULL);
    STAssertNil(ROR,@"MISSED",NULL);
    RA = [URL getXtdAttributeNames4iTM3WithOptions:ZER0 error:self.RORef4iTM3];
    STAssertNotNil(RA,@"MISSED",NULL);
    STAssertTrue((RA.count==ZER0),@"MISSED",NULL);
