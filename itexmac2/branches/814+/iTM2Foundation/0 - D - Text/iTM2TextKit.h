...
/*!
	...
	@discussion	If the column number does not fit in the line range, the whole line is highlighted.
...
- (NSNumber *)locationValueOfRangeValue4iTM3;// for sort descriptors
@end
