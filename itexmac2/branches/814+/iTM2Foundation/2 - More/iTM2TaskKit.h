...
@interface iTM2TaskInspector: iTM2Inspector <iTM2TaskInspector, NSTextViewDelegate>
{
@private
	iTM2TaskController * __weak iVarTaskController4iTM3;
    NSTextView * iVarOutputView4iTM3;
    NSTextView * iVarErrorView4iTM3;
}
@property (nonatomic,assign, readonly) __weak iTM2TaskController * taskController;
@property (assign, readonly) NSTextView * errorView;
@property (assign, readonly) NSTextView * outputView;
...
@property (assign,readonly) NSMutableArray * wrappers;
@property (assign,readonly) NSString * conversation;
...
/*! 
    ...
    @result     yorn.
*/
@property (getter=isDeaf,setter=setDeaf:) BOOL deaf;
...
/*! 
    ...
    @discussion This allows control from the task currently working.
                The shell command AppleScript4iTM3 is useable from any shell script.
                ...
                AppleScript4iTM3 --execute "tell application \"Finder\"\nbeep\nend tell"
