/*
//
//  @version Subversion: $Id: iTM2InstallationKit.h 715 2008-02-06 12:45:30Z jlaurens $ 
//
...
/*!
	...
	@discussion	For all the strict subclasses of the receiver, the messages +...CompleteInstallation4iTM3 are sent.
				...
				it is sent when the NSApplicationCompleteWillFinishLaunching4iTM3Notification is sent.
	@param		None
	@result		None
*/
...
/*!
	...
	@discussion		Will perform all the +...CompleteInstallation4iTM3 methods of the receiver.
					...
					This message is sent before the NSApplicationCompleteWillFinishLaunching4iTM3Notification is sent.
...
/*!
	...
	@discussion		This method is overriden to perform 4 tasks:
					...
					- make the receiver perform all its -...CompleteWillFinishLaunching4iTM3 methods,
					- perform the inherited method
					- make the receiver perform all its -...CompleteDidFinishLaunching4iTM3 methods.
					...
					The +...CompleteInstallation4iTM3 methods of the main installer should only be used to low level initialization
...
/*!
	...
	@discussion	The default implementation sends all the ...FixInstallation4iTM3 messages available.
...
/*!
	...
	@discussion	The default implementation sends all the ...CompleteInstallation4iTM3 messages available.
